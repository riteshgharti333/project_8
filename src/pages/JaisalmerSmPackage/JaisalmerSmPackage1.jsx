...
const JaisalmerSmPackage1 = () => {
  ...
  return (
    <div>
      <ServiceBanner
        bannerTitle={title}
        bannerImg={JaisalmerHalfDayTour.stContent1.img}
      />
      <div className="sm:max-w-[750px] lg:max-w-[1100px] m-auto flex flex-col gap-20 mt-10 px-2">
        <SmTourPackageComp smPackageData={JaisalmerHalfDayTour} />
...
export default JaisalmerSmPackage1;
